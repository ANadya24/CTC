...
class VoxelMorph2d(nn.Module):
    ...
    def __init__(self, in_channels, use_gpu=True):
        ...
        self.spatial_transform = SpatialTransformation(use_gpu=use_gpu)
...
#        fixed_image, theta_fixed = self.stn(fixed_image)
...
class DefNet(nn.Module):
    ...
    def __init__(self, vol_size, use_gpu=True, in_channel=2):
        """
    ...
    def forward(self, src, tgt):
        ...
        #print(src.shape, flow.shape, x.shape)
