...
#    use_mask = config["masks"]
    ...
    copytree('/data/sim/CTC/src/', save_dir + '/src/')
    ...
    vm = VoxelMorph2d(2)#cvpr2018_net(data_shape[1:], nf_enc, nf_dec)
...
#                                use_gpu=use_gpu, n=9, def_lambda=def_lambda)
    ...
    train(load_epoch, max_epochs, training_generator, validation_generator, vm, optimizer,
          device, None, save_dir, model_name, image_dir, save_step, use_gpu, use_tensorboard=use_tensorboard,
          logdir=logdir)
